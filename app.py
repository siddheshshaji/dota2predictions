...
def predict():
    ...
    if len(set(response)) == 10:    # EXCEPTION HANDLING CONDITION 1: TO WHETHER A SINGLE HERO HAS BEEN SELECTED BY MORE THAN ONE PLAYERS IN THE SAME TEAM
        for i in response:
        ...
        non_zeroes = [x for x in response if x != 0] # EXCEPTION HANDLING CONDITION 1: TO WHETHER A SINGLE HERO HAS BEEN SELECTED BY MORE THAN ONE PLAYERS FROM DIFFERENT TEAMS
